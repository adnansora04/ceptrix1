...
waitForElement('.elementor .elementor-element  #announcement-banner', () => {
    ...
    document.addEventListener('mouseout', e => {
      ...
      <div class="gmd-popup-content">
            ...
            <div class="gmd-text">Boost team efficiency <br>by modernizing <span>frontline communications</span></div>
            <ul >
            ...
            <a href="https://relaypro.com/contact-sales/" class="gmd-btn">GET A DEMO</a>
        </button>
        </div>
    `;
    ...
    popup.querySelector('.gmd-close').onclick = () => popup.remove();
    
    document.onkeydown = e => { if (e.key === 'Escape') popup.remove(); };
